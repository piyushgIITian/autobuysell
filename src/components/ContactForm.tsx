  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Thank you!",
        description:
          "Our team will contact you shortly to discuss your trading needs.",
        variant: "default",
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          placeholder="Tell us about your trading needs and goals..."
          id="content"
          required
          value={message}
      ...
      >
        {loading ? (
          ...
          <div className="flex items-center justify-center">
            Get Started <ChevronRight className="w-4 h-4 ml-4" />
          </div>
        )}
        <BottomGradient />
      </Button>
